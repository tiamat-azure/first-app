package nc.opt.fapp.repository;

import nc.opt.fapp.FappApp;
import nc.opt.fapp.config.Constants;
import nc.opt.fapp.config.audit.AuditEventConverter;
import nc.opt.fapp.domain.PersistentAuditEvent;
...
import static nc.opt.fapp.repository.CustomAuditEventRepository.EVENT_DATA_COLUMN_MAX_LENGTH;
